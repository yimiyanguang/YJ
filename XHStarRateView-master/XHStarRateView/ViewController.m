...
- (void)viewDidLoad {
    ...
    XHStarRateView *starRateView2 = [[XHStarRateView alloc] initWithFrame:CGRectMake(20, 100, 200, 30) numberOfStars:5 rateStyle:WholeStar isAnination:NO delegate:self];
    starRateView2.tag = 2;
